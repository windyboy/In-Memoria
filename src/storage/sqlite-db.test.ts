...
import { createTestDatabase, createMockConcept, createMockChunk } from '../utils/test-helpers.js';
...
describe('SQLiteDatabase', () => {
    ...
    describe('semantic concepts', () => {
        ...
        it('should filter concepts by type', () => {
            ...
            db.replaceSemanticConcepts(concepts);
            const result = db['db']
                .prepare(`SELECT * FROM semantic_concepts WHERE concept_type = ?`)
                .all('function');
            ...
            const patterns = [
                {
                    ...
                    patternData: JSON.stringify({ pattern: 'camelCase' }),
                    confidence: 0.9,
        ...
        it('should retrieve developer patterns', () => {
            const patterns = [
                ...
                },
                {
                    ...
                    patternData: JSON.stringify({ pattern: 'barrel' }),
                    confidence: 0.8,
                    metadata: JSON.stringify({}),
                },
            ];
    ...
    describe('error handling', () => {
        ...
        it('should handle SQL injection attempts', () => {
            ...
            expect(() => db.replaceSemanticConcepts([maliciousConcept])).not.toThrow();

...
describe("SearchEngine", () => {
    ...
    beforeEach(() => {
        ...
        mockPatternEngine = new PatternEngine(
            {} as any,
        ) as Mocked<PatternEngine>;
        mockDatabase = {};
    ...
    describe("search", () => {
        ...
        it("should call textSearch for text type", async () => {
            ...
            vi.spyOn(searchEngine as any, "textSearch").mockResolvedValue(
                mockResult,
            );
    ...
    describe("semanticSearch", () => {
        it("should return results from semantic engine", async () => {
            ...
            expect(
                mockSemanticEngine.searchSemanticallySimilar,
    ...
    describe("patternSearch", () => {
        it("should return results from pattern engine", async () => {
            ...
            mockPatternEngine.findRelevantPatterns.mockResolvedValue(
                mockPatterns,
            );
            ...
            vi.spyOn(searchEngine as any, "matchesPattern").mockReturnValue(
                true,
            );
